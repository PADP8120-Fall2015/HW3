...
```
Does the distribution of voting evaluation depend on whether the voter used e-voting?
```{r}
...
```
We can reject the null because the $p_{obs} < p_{0.01}$. Based on these statistics, there is good evidence that there is a significant difference in the proportion of voters who approved of President Bush (43) before and after Hurricane Katrina.
